...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('行李箱检测系统')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/UI/suitcase.jpg"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap())
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap())
        ...
        about_title = QLabel('欢迎使用机场行李箱检测系统')  # todo 修改欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel('系统主要检测行李箱，请上传行李箱图片或视频')
        ...
        label_super.setText("<a>基于深度学习的行李检测系统</a>")
        ...
        self.setTabIcon(0, QIcon())
        self.setTabIcon(1, QIcon())
        # self.setTabIcon(2)
    ...
    ***检测图片***
    ...
    def detect_img(self):
        ...
        # print(source)
        if source == "":
            QMessageBox.warning(self, "请上传", "请上传图片后再进行检测")
        else:
            source = str(source)
